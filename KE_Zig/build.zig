...
pub fn build(b: *std.Build) void {
    ...
    const mandlebrot_exe = b.addExecutable(.{
        .name = "zig_mandlebrot",
        // In this case the main source file is merely a path, however, in more
        // complicated build scripts, this could be a generated file.
        .root_source_file = .{ .path = "src/mandlebrot.zig" },
        .target = target,
        .optimize = optimize,
    });
    ...
    const run_step = b.step("run_mandlebrot", "Run the app");
    run_step.dependOn(&mandlebrot_run_cmd.step);



    const minigrep_exe = b.addExecutable(.{
        .name = "zig_minigrep",
        .root_source_file = .{ .path = "src/minigrep.zig" },
        .target = target,
        .optimize = optimize,
    });
    ...
    const minigrep_run_step = b.step("run_minigrep", "Run the app");
